 ...
 *
 */
public class DaughterTracker extends ExternalWindow implements MouseListener {

		public static DaughterTracker current;
	    ...
	    JButton button, buttonS, button2, button3, button4, button5, buttong, buttonb;
	    JTextField searchString, searchString1, searchString2, searchString3;
	    JLabel titleLabel, daughterLabel, numberLabel, numberLabel2, numberLabel3,IDLabel, cellLabel, mouseLabel, mouseMoveLabel, stringLabel, selectionLabel;
	    ...
	    private void initialize() {
	        ...
	        scrollPane.setLocation(10, 300);//90, 310
	        ...
	        daughterLabel.setLocation(30, 110);
	        ...
	        numberLabel.setLocation(80, 132);
	        numberLabel.setSize(70, 40);
	        getContentPane().add(numberLabel);
	        
	     // Number Label2
	        numberLabel2 = new JLabel("");
	        numberLabel2.setForeground(new Color(50,205,50));
	        numberLabel2.setLocation(80, 250);
	        numberLabel2.setSize(70, 40);
	//        getContentPane().add(numberLabel2);
	        
	        // Number Label3
	        numberLabel3 = new JLabel("");
	        numberLabel3.setForeground(Color.BLUE);
	        numberLabel3.setLocation(130, 250);
	        numberLabel3.setSize(70, 40);
	//        getContentPane().add(numberLabel3);
	        ...
	        //searchString2
		     ...
		     searchString2.setLocation(10, 100);
	...
	//	        getContentPane().add(searchString2);
		      ...
		      //searchString3
			     searchString3 = new JTextField(8);
			     searchString3.setLocation(10, 160);
			     searchString3.setSize(150, 30);
			     searchString3.addActionListener(new ActionListener() {
			        	public void actionPerformed(ActionEvent e) {	
			        	}
			        });
		//	        getContentPane().add(searchString3);
	     ...
	     /*// ButtonS 
	        ...
	        buttong = new JButton("Color Daughters");
	        buttong.setLocation(10, 130);
	        buttong.setSize(150, 30);
	        buttong.addActionListener(new ActionListener() {
	        	public void actionPerformed(ActionEvent e) {
	        		
	        		ECM.selectionType = 2;//&3;
					ECM.drawDaughterTracker = true;
					//ECM.searchInt = Integer.parseInt(searchString.getText().trim());
					ECM.searchRegex = searchString2.getText().trim();
					ECM.searchIntLength = searchString2.getText().length();
	    ...
	    //    getContentPane().add(buttong);
	        ...
	        buttonb = new JButton("Color Daughters B");
	        buttonb.setLocation(10, 190);
	        buttonb.setSize(150, 30);
	        buttonb.addActionListener(new ActionListener() {
	        	public void actionPerformed(ActionEvent e) {
	        		
	        		ECM.selectionType = 3;//&3;
					ECM.drawDaughterTracker = true;
					//ECM.searchInt = Integer.parseInt(searchString.getText().trim());
					ECM.searchRegex = searchString3.getText().trim();
					ECM.searchIntLength = searchString3.getText().length();
					numberLabel2.setText(""+ECM.daughterCount2);
					MonitoringGui.getCurrent().repaint();
	  ...
	  //      getContentPane().add(buttonb);
	     ...
	     // Button2 (Clear button)
	        ...
	        button2.setLocation(45, 170);//135, 170
	        button2.setSize(80, 30);
	        button2.addActionListener(new ActionListener() {
	            public void actionPerformed(ActionEvent e) {
	            	{
	            	searchString.setText("");
	            	searchString2.setText("");
	            	searchString3.setText("");
	     ...
	     // Button3 
	        ...
	        button3.setLocation(45, 200);//135 200
	     ...
	     // Button4 
	        ...
	        button4.setLocation(45, 230);//135 230
	        ...
	        button5.setLocation(45, 380);//135, 260
...
*/ 
		...
		//		shown.addElement("Daughter count B: "+ECM.daughterCount3);
				numberLabel.setText(""+ECM.daughterCount);
		//		numberLabel2.setText(""+ECM.daughterCount2);
		//		numberLabel3.setText(""+ECM.daughterCount3);
