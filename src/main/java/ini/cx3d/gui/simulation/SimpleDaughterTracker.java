 ...
 * to track daughter cells in the simplest form
 *  
 * @author gabrielamichel
 *
 */
public class SimpleDaughterTracker extends ExternalWindow implements MouseListener {

		public static SimpleDaughterTracker current;
	    ...
	    private void initialize() {
	        ...
	        scrollPane.setLocation(10, 310);//90, 310
	        ...
	        daughterLabel.setLocation(30, 100);
	        ...
	        numberLabel.setLocation(80, 130);
	    ...
	    //    getContentPane().add(buttonS);
	     ...
	     // Button4 
	        ...
	        button4.addActionListener(new ActionListener() {
	            public void actionPerformed(ActionEvent e) {
	               SimpleDaughterTracker.this.setVisible(false);	     //close Daughter Finder         
	            }
	        });
	        ...
	        button5.setLocation(45, 260);//135, 260
